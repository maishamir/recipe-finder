        ...
        <div className='home'>
            <section className='home__hero'>
                <div className="home__hero-text">
                    ...
                    <p className='home__hero-subtitle home__hero-subtitle--mob'>Discover eight quick, whole-food recipes that you can cook tonight&mdash;no processed junk, no guesswork.</p>
                    <p className='home__hero-subtitle home__hero-subtitle--dk'>Discover eight quick, whole-food recipes that you can cook tonight<br />&mdash;no processed junk, no guesswork.</p>
            ...
            <section className="home__real-life">
                <div className="home__real-life-txt">
